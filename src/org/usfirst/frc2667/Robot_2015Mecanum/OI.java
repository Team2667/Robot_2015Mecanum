...
import org.usfirst.frc2667.Robot_2015Mecanum.commands.turn180;
...
public class OI {
    ...
    public JoystickButton do180Button;
    ...
    public OI() {
        ...
        do180Button = new JoystickButton(joystick, 1);
        do180Button.whenPressed(new turn180());
